<template>
  <section class="new-arrival text-center">
    ...
    <div class="swiper-container">
      <div class="swiper-wrapper cards d-flex align-items-center justify-content-center">
        <div
          ...
          <div class="card-body">
            ...
            >
              <span class="fs-5 p-1 w-75 rounded-2 ms-2 text-light"
                ><del class="me-2 text-dark">{{ card.product.sallary+(card.Value*10) }}$</del
                >{{ card.product.sallary }}$</span
              >
              <button
                class="btn ms-3 w-25"
                @click="addtocart(card.product._id)"
              >
